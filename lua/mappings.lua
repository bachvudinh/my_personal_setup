...
-- LSP navigation (like VSCode F12, Shift+F12, etc.)
...
map("n", "<leader>ld", vim.diagnostic.open_float, { desc = "LSP Show line diagnostics" })
...
map("t", "<ESC><CR>", "<C-\\><C-n>", { desc = "Terminal Enter normal mode" })
